...
class SessionManager {
	...
	public static function cleanUser(){
		unset($_SESSION[SessionManager::hash()][sha1(Pessoa::$NM_ENTITY)]);
	}
	
	public static function setUser($user){
		$_SESSION[SessionManager::hash()][sha1(Pessoa::$NM_ENTITY)] = $user; 
	}

	public static function getUser(){
		return $_SESSION[SessionManager::hash()][sha1(Pessoa::$NM_ENTITY)];
	}
	
	public static function hasUser(){
		return isset($_SESSION[SessionManager::hash()][sha1(Pessoa::$NM_ENTITY)]);
	} 
