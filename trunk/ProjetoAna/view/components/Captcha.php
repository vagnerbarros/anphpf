...
<div id="group_<?php echo Proxy::encrypt('captcha');?>"
	...
	<div class='controls'
		style="width: 300px; background: transparent; margin-bottom: 10px;">
		<div style="height: 50px;">
			<img id="siimage" width='190px' height='40px' align="left"
				style="padding-right: 2px; border: none; top: 5px;"
			...
			<a tabindex="-1" style="border-style: none; position: relative; float: left; margin-left: 10px; margin-top: 5px;" href="#"
				title="Refresh Image"
		...
		<label style="width: 176px">Digite as letras:</label>
