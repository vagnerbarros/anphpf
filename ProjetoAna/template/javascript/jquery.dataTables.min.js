...
this._iDisplayStart + this.aiDisplay.length : Math.min(this._iDisplayStart + this._iDisplayLength, this._iRecordsDisplay) : this._iDisplayEnd
                ...
                sLengthMenu: "Exibir _MENU_ registros", sZeroRecords: "NENHUM REGISTRO ENCONTRADO!", sEmptyTable: "NENHUM REGISTRO ENCONTRADO!", sInfo: "Exibindo do _START_ até _END_ de _TOTAL_ registros", sInfoEmpty: "Exibindo 0 de 0 registros", sInfoFiltered: "(filtrado de _MAX_ registros totais)", sInfoPostFix: "", sSearch: "Pesquisar:", sUrl: "", oPaginate: { sFirst: "Primeiro", sPrevious: "Anterior", sNext: "Próximo", sLast: "Último" }, fnInfoCallback: null
